...
public class CartaoService {
    ...
    public CartaoNovoDto criar(CartaoNovoDto cartaoNovo) {
        ...
        Cartao cartao = cartaoNovoValorPadrao();
        cartao.setSenha(cartaoNovo.senha());
        cartao.setNumeroCartao(cartaoNovo.numeroCartao());
    ...
    private Cartao cartaoNovoValorPadrao() {
        Cartao cartao = new Cartao();
        cartao.setSaldo(BigDecimal.valueOf(500.00).setScale(2, RoundingMode.DOWN));
        return cartao;
    }
